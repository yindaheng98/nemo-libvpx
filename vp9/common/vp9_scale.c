...
MV32 vp9_scale_nemo_mv(const MV *mv, int x, int y,
...
void vp9_setup_scale_factors_for_sr_frame(struct scale_factors *sf, int other_w,
                                          int other_h, int this_w, int this_h,
                                          bool upsample, bool add, int scale) {
#endif
  ...
  */
  ...
  if (sf->x_step_q4 == 16) {
    ...
    if (sf->y_step_q4 == 16) {
      ...
      if (add) {
        //                sf->predict_residual[0][0][0] =
        //                vpx_bilinear_interp_add_c;
        //                sf->predict_residual[0][0][1] =
        //                vpx_bilinear_interp_add_c;
        //                sf->predict_residual[0][1][0] =
        //                vpx_bilinear_interp_add_c;
        //                sf->predict_residual[0][1][1] =
        //                vpx_bilinear_interp_add_c;
        //                sf->predict_residual[1][0][0] =
        //                vpx_bilinear_interp_add_c;
        //                sf->predict_residual[1][0][1] =
        //                vpx_bilinear_interp_add_c; sf->predict[0][0][0] =
        //                vpx_scaled_2d; sf->predict[0][0][1] =
        //                vpx_scaled_avg_2d; sf->predict[0][1][0] =
        //                vpx_scaled_2d; sf->predict[0][1][1] =
        //                vpx_scaled_avg_2d; sf->predict[1][0][0] =
        //                vpx_scaled_2d; sf->predict[1][0][1] =
        //                vpx_scaled_avg_2d;
      } else {
