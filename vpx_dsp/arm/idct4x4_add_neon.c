...
void vpx_idct4x4_16_add_neon(const tran_low_t *input, uint8_t *dest,
  ...
  d01_u16 = vaddw_u8(vreinterpretq_u16_s16(a0),
                     dest01_u8);  // hyunho: a0, a1 seems to be residual value
  d32_u16 =
      vaddw_u8(vreinterpretq_u16_s16(a1), vreinterpret_u8_u32(dest32_u32));
  d01 = vqmovun_s16(
      vreinterpretq_s16_u16(d01_u16));  // hyunho: this seems to apply clip
